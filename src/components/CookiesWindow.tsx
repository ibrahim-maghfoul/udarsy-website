        ...
        <AnimatePresence>
            {isVisible && (
                <motion.div
                    ...
                    className="fixed bottom-8 right-8 z-[100] [--shadow:rgba(60,64,67,0.3)_0_1px_2px_0,rgba(60,64,67,0.15)_0_2px_6px_2px] w-[90%] md:w-auto h-auto rounded-2xl bg-white [box-shadow:var(--shadow)] max-w-[300px]"
                >
                    <div className="flex flex-col items-center justify-between pt-9 px-6 pb-6 relative">
                        ...
                        <div className="flex w-full items-center justify-between mt-2">
                            <button className="text-sm text-zinc-500 cursor-pointer font-semibold transition-colors hover:text-dark hover:underline underline-offset-2">
                                More Options
                            </button>
                            <button
                                onClick={handleAccept}
                                className="font-semibold cursor-pointer py-2 px-8 w-max break-keep text-sm rounded-lg transition-colors text-white hover:text-white bg-green hover:bg-dark"
                                type="button"
                            >
                                Accept
                            </button>
